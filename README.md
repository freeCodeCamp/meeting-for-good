...
We welcome pull requests from seasoned Javascript developers. Please read our guide[https://github.com/freeCodeCamp/meeting-for-good/blob/contrib-guide/CONTRIBUTING.md](url) first, then check out our open issues.
